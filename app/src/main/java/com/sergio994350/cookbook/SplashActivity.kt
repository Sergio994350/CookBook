package com.sergio994350.cookbook
...
import com.sergio994350.cookbook.database.RecipeDatabase
...
import com.sergio994350.cookbook.interfaces.GetDataService
import com.sergio994350.cookbook.retrofitclient.RetrofitClientInstance
...
class SplashActivity : BaseActivity(), EasyPermissions.RationaleCallbacks,
    ...
    private var READ_STORAGE_PERMISSIONS = 123
   ...
   fun getCategories() {
        ...
        call.enqueue(object : Callback<Category> {
            override fun onFailure(call: Call<Category>, t: Throwable) {
                Toast.makeText(this@SplashActivity, "Something is wrong", Toast.LENGTH_SHORT)
                    .show()
            }
